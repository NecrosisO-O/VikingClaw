...
class AsyncOpenViking:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            # Keep singleton reusable after constructor failures (e.g. port conflicts).
            self._initialized = False
            self._singleton_initialized = False
            raise
    ...
    async def commit_session(
        ...
        await self._ensure_initialized()
        return await self._client.commit_session(session_id, cause=cause)
    ...
    async def add_events_batch(
        ...
        await self._ensure_initialized()
        return await self._client.add_events_batch(session_id=session_id, events=events)

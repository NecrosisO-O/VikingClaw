...
export const FIELD_HELP: Record<string, string> = {
  ...
  "memory.backend":
    'Memory backend ("builtin" for OpenClaw embeddings, "qmd" for QMD sidecar, "openviking" for OpenViking Context OS).',
  ...
  "memory.openviking.endpoint": "OpenViking server base URL (default: http://127.0.0.1:9432).",
  "memory.openviking.apiKey": "OpenViking API key sent as X-API-Key header.",
  "memory.openviking.headers": "Additional headers forwarded to OpenViking requests.",
  "memory.openviking.timeoutMs": "Request timeout for OpenViking HTTP calls (default: 10000).",
  "memory.openviking.targetUri":
    "Default target URI scope for OpenViking retrieval (default: empty string, search all context types).",
  "memory.openviking.dualWrite":
    "Enable dual-write session event streaming to OpenViking (default: true).",
  "memory.openviking.commit.mode":
    'Commit mode for OpenViking session archive updates ("async" default, or "sync").',
  "memory.openviking.commit.triggers.sessionEnd":
    "Queue OpenViking commit when OpenClaw session ends (default: true).",
  "memory.openviking.commit.triggers.reset":
    "Queue OpenViking commit before /new or /reset session replacement (default: true).",
  "memory.openviking.commit.triggers.everyNMessages":
    "Periodic commit after N streamed events/messages (default: 24).",
  "memory.openviking.commit.triggers.everyNMinutes":
    "Periodic commit cadence in minutes while session stays active (default: 12).",
  "memory.openviking.outbox.enabled":
    "Enable local OpenViking outbox queue worker (default: true).",
  "memory.openviking.outbox.path":
    "Optional file or directory for outbox persistence (default under session store dir).",
  "memory.openviking.outbox.flushIntervalMs":
    "Outbox flush interval in milliseconds (default: 2000).",
  "memory.openviking.outbox.maxBatchSize":
    "Max queued envelopes flushed per interval tick (default: 25).",
  "memory.openviking.outbox.retryBaseMs": "Initial retry delay when flush fails (default: 1000).",
  "memory.openviking.outbox.retryMaxMs":
    "Maximum retry backoff for failed flushes (default: 60000).",
  "memory.openviking.fsWrite.enabled":
    "Enable OpenViking filesystem write operations (mkdir/rm/mv). Default: false.",
  "memory.openviking.fsWrite.allowUriPrefixes":
    "Allowlist URI prefixes for OpenViking fs writes. Writes are denied unless uri matches one of these prefixes.",
  "memory.openviking.fsWrite.denyUriPrefixes":
    "Denylist URI prefixes for OpenViking fs writes (evaluated before allowlist).",
  "memory.openviking.fsWrite.protectedUris":
    "Protected URIs that are always rejected for fs writes (exact path match).",
  "memory.openviking.fsWrite.allowRecursiveRm":
    "Allow recursive removal in fs-rm when true (default: false).",
  "memory.openviking.search.limit":
    "Default OpenViking retrieval result cap for memory_search (default: 10).",
  "memory.openviking.search.scoreThreshold":
    "Optional minimum score threshold forwarded to OpenViking search.",
  "memory.openviking.search.targetUri": "Override target URI for OpenViking search requests.",
  "memory.openviking.search.includeResources":
    "Include resource contexts from OpenViking in memory_search output (default: false).",
  "memory.openviking.search.includeSkills":
    "Include skill contexts from OpenViking in memory_search output (default: false).",
  "memory.openviking.search.explainability":
    "Emit OpenViking query_plan/query_results summaries into logs and memory status custom fields (default: false).",
  "memory.openviking.search.strategy":
    "OpenViking context mix strategy: auto | memory_first | resource_first | skill_first (default: auto).",
  "memory.openviking.search.readLayer":
    "Snippet read layer for OpenViking search: l0 | l1 | l2 | progressive (default: progressive).",
  "memory.openviking.search.maxEntries":
    "Maximum search hits kept for memory_search context injection after ranking (default: 6).",
  "memory.openviking.search.maxSnippetChars":
    "Maximum characters per OpenViking snippet after layered read (default: 560).",
  "memory.openviking.search.maxInjectedChars":
    "Maximum total characters injected from OpenViking search snippets per turn (default: 3200).",
  "memory.openviking.search.relationExpansion":
    "Enable relation-expanded recall from /api/v1/relations (default: false).",
  "memory.openviking.search.relationMaxDepth":
    "Maximum BFS depth for relation expansion when enabled (default: 1).",
  "memory.openviking.search.relationMaxAnchors":
    "Maximum direct-hit anchors used to seed relation expansion (default: 2).",
  "memory.openviking.search.relationMaxExpandedEntries":
    "Maximum relation-expanded candidates merged into ranking before budgeting (default: 4).",
  "memory.openviking.search.relationSeedAnchorScore":
    "Fallback score used for planner target_directories seeded into relation expansion (default: 0.55).",
  "memory.openviking.search.relationPriorityBudgetBoost":
    "When true, applies extra relation expansion budget for non-memory priority (default: true).",
  "memory.openviking.search.relationPriorityDepthBonus":
    "Additional relation expansion depth when priority budget boost is active (default: 1).",
  "memory.openviking.search.relationPriorityAnchorsBonus":
    "Additional anchor slots when priority budget boost is active (default: 1).",
  "memory.openviking.search.relationPriorityExpandedBonus":
    "Additional expanded candidate slots when priority budget boost is active (default: 2).",

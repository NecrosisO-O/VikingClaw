...
export type SessionEntry = {
  ...
  /** Linked OpenViking session id when memory backend is openviking. */
  openvikingSessionId?: string;
  /** Last successful OpenViking commit timestamp (ms). */
  lastCommitAt?: number;
  /** Last synced OpenViking event sequence number. */

...
const MemoryOpenVikingCommitTriggersSchema = z
  .object({
    sessionEnd: z.boolean().optional(),
    reset: z.boolean().optional(),
    everyNMessages: z.number().int().positive().optional(),
    everyNMinutes: z.number().int().positive().optional(),
  })
  .strict();

const MemoryOpenVikingCommitSchema = z
  .object({
    mode: z.union([z.literal("sync"), z.literal("async")]).optional(),
    triggers: MemoryOpenVikingCommitTriggersSchema.optional(),
  })
  .strict();

const MemoryOpenVikingOutboxSchema = z
  .object({
    enabled: z.boolean().optional(),
...
const MemoryOpenVikingFsWriteSchema = z
  .object({
    enabled: z.boolean().optional(),
    allowUriPrefixes: z.array(z.string()).optional(),
    denyUriPrefixes: z.array(z.string()).optional(),
    protectedUris: z.array(z.string()).optional(),
    allowRecursiveRm: z.boolean().optional(),
  })
  .strict();

const MemoryOpenVikingSearchSchema = z
  .object({
    limit: z.number().int().positive().optional(),
    scoreThreshold: z.number().nonnegative().optional(),
    ...
    strategy: z
      .union([
        z.literal("auto"),
        z.literal("memory_first"),
        z.literal("resource_first"),
        z.literal("skill_first"),
      ])
      .optional(),
    readLayer: z
      .union([z.literal("l0"), z.literal("l1"), z.literal("l2"), z.literal("progressive")])
      .optional(),
    maxEntries: z.number().int().positive().optional(),
    maxSnippetChars: z.number().int().positive().optional(),
    maxInjectedChars: z.number().int().positive().optional(),
    relationExpansion: z.boolean().optional(),
    relationMaxDepth: z.number().int().positive().optional(),
    relationMaxAnchors: z.number().int().positive().optional(),
    relationMaxExpandedEntries: z.number().int().positive().optional(),
    relationSeedAnchorScore: z.number().nonnegative().optional(),
    relationPriorityBudgetBoost: z.boolean().optional(),
    relationPriorityDepthBonus: z.number().int().nonnegative().optional(),
    relationPriorityAnchorsBonus: z.number().int().nonnegative().optional(),
    relationPriorityExpandedBonus: z.number().int().nonnegative().optional(),
  })
  .strict();

const MemoryOpenVikingSchema = z
  .object({
    endpoint: z
      .string()
      .url()
    ...
    commit: MemoryOpenVikingCommitSchema.optional(),
    outbox: MemoryOpenVikingOutboxSchema.optional(),
    fsWrite: MemoryOpenVikingFsWriteSchema.optional(),
    search: MemoryOpenVikingSearchSchema.optional(),
  })
  .strict();

const MemorySchema = z
  .object({
    backend: z.union([z.literal("builtin"), z.literal("qmd"), z.literal("openviking")]).optional(),
    citations: z.union([z.literal("auto"), z.literal("on"), z.literal("off")]).optional(),
    qmd: MemoryQmdSchema.optional(),
    openviking: MemoryOpenVikingSchema.optional(),
  })
  .strict()
  .optional();
